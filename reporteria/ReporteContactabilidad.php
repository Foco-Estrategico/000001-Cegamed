...
$objetoSession->crearVariableSession($array = array("idMenu" => "gra,est_seg"));
                            ...
                            <div class="panel-body" width="100%">
                                 <div class="row">          
                                    <div class="col-sm-4">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                 <label for="sel1">Seleccione Segmento:</label>   
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <select class="selectpicker" id="segmento" name="segmento" data-live-search="true" data-width="100%">
                                                <?php echo $_SESSION['cedente']; if ($_SESSION['cedente'] == '47'){ ?>
