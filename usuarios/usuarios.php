                  ...
                  <div id="contenedor"></div>
                    <div class="panel" id='sql'>
                      ...
                      <div class="panel-body">
                        <div class="col-sm-3">
                          <div class="form-group" style="<?php echo $visible ?>">
                           <button class="btn btn-primary btn-block gestionar_usu" onclick="location.href='crear_usuarios.php'">Nuevo Usuario</button>
                          </div>
                        </div>
                        <div class="listaUsuarios"></div>
                        <form id="SubmitModusuario" action="crear_usuarios.php" method="post">
