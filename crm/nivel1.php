...
if($lista==-1)
{
	...
	while($r = mysql_fetch_array($q1))
	{
		...
		$q4 = mysql_query("SELECT Rut FROM Ultima_Gestion WHERE Respuesta_N2 = $id AND Id_Cedente = $cedente ");
...
else
{
	...
	while($r = mysql_fetch_array($q1))
	{
		...
		$q4 = mysql_query("SELECT Rut FROM Ultima_Gestion WHERE Respuesta_N2 = $id AND Id_Cedente = $cedente and lista=$lista");
		$r4 = mysql_num_rows($q4); 
