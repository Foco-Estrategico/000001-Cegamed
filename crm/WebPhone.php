    ...
    <div id="content">
        <div id="left_column">
            <div id="registration_box">
                ...
                <div id="status">&nbsp;</div>
                <div class="reg_form">
                    <input type="hidden" placeholder="SIP server address" id="serveraddress" value="192.168.1.8" title="SIP server IP address or domain name" />
                </div>
                <div class="reg_form">
                    <input type="hidden" placeholder="Username" id="username" value="1002" title="SIP account username" />
                </div>
                <div class="reg_form">
                    <input type="hidden" placeholder="Password" id="password" value="mauro123" title="SIP account password" />
                </div>
...
<input type="hidden" id="IdCedente" value="<?php echo $_SESSION['cedente'];?>">
                ...
                <div id="page-content">
                    ...
                    <div class="row col-lg-12" id="ProgressBar">
                        <div class="col-lg-12" style="text-align: center;">
                            <h3>Barra de Progreso de la Asignación</h3>
                        </div>
                        <div class="col-lg-12">
                            <div class="col-lg-8 col-lg-offset-2"><div class="progress progress-xl"><div class="progress-bar progress-bar-success"></div></div></div>
                        </div>
                    </div>
   ...
   <script src="../js/jquery-2.2.1.min.js"></script>
    ...
    <script src="webphone/js/techdemo_example/stringres.js"></script>
               

    <script src="webphone/js/techdemo_example/picoModal.js"></script>
    <script src="webphone/webphone_api.js"></script>
    <script src="webphone/js/techdemo_example/techdemo_example.js"></script>
