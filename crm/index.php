...
$nombre_usuario  = '';
$QueryUsuario  =mysql_query("SELECT nombre FROM Usuarios WHERE usuario = '$NombreUsuarioFoco' LIMIT 1");
while($row = mysql_fetch_array($QueryUsuario)){
        ...
        <div class="boxed">
            <div id="content-container">
                ...
                <div id="page-content">
                  ...
                  </div> <!-- aquiii cierra row -->
                    <div class="row col-lg-12" id="ProgressBar">
                       <!-- <div class="col-lg-12" style="text-align: center;">
                            <h5>Barra de Progreso de la Asignación</h5>
                        </div> -->
                        <div class="col-lg-12">
                            <div class="col-lg-8 "><div class="progress progress-xl"><div class="progress-bar progress-bar-success"></div></div></div>
                            <div class="col-lg-2">
                                <div class="row">

                                 <div class="col-lg-12" align="center" style="background-color: #F3F781; display: inline-block; padding: 2px 5px" id="cantidadRut"></div>
                            ...
                            <div class="col-lg-2">
                                <div class="row">
                                 ...
                                 <div class="col-lg-12" align="center">
                                    <select class="select2" id="reinicioAsignacion"  name="reinicioAsignacion">
                                        <option value="0">Seleccione</option>
                                        <option value="1">Sin Gestion</option>
                                        <option value="2">Sin Contacto</option>
                                ...
                                <div class="panel" id="demo-panel-collapse" class="collapse in">
                                    ...
                                    <div class="panel-body ">
                                        <div class="col-sm-12">
                                            ...
                                            <b><span id="nombre_cliente"></span></b>
                    ...
                    <!--Nav Tabs-->
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li>
                                    <a data-toggle="tab" href="#demo-lft-tab-6">Gestiones Correo</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="demo-lft-tab-5" class="tab-pane fade">
                                 ...
                                 <div id="demo-lft-tab-6" class="tab-pane fade">
                                    <div id="mostrar_gestion_correo_ocultar">Gestiones de Correo</div>
                                    <div id="mostrar_gestion_correo"></div>
                                </div>
