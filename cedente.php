					...
					<form action="estrategia/sesion_cedente.php" method="POST">
						<div class="form-group">
							<div class="input-group">
								...
								<?php
                                $sql = mysql_query("SELECT distinct Cedente.Id_Cedente , Cedente.Nombre_Cedente FROM Cedente inner join mandante_cedente on mandante_cedente.Id_Cedente = Cedente.Id_Cedente INNER JOIN mandante on mandante.id = mandante_cedente.Id_Mandante where mandante.id='".$_SESSION['mandante']."' ORDER BY Cedente.Nombre_Cedente ASC");
