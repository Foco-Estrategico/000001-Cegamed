    ...
    <div class="navbar-content clearfix">
      ...
      <ul class="nav navbar-top-links pull-right">
        ...
        if (file_exists('../perfil/img-profile/'.$_SESSION['id_usuario'].'.jpg')) {
          $img = '<img class="img-circle img-user media-object"  src="../perfil/img-profile/'.$_SESSION['id_usuario'].'.jpg" class="img-lg img-circle" alt="Profile Picture">';
        } else {
          if ($_SESSION['sexo_usuario'] == "F"){
            $img =  '<img class="img-circle img-user media-object" src="../img/av6.png" class="img-lg img-circle" alt="Profile Picture">';
          }else{
