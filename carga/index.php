											...
											<div class="list-group" id="TableStatus">
												<?php
													if(!isset($_GET['tipo'])){
														...
														?>
															<a class="list-group-item list-group-item-danger" id="TablePagos">Tabla Pagos</a>
														<?php
													}
												?>
												<br>
												<div class="form-group">
													...
													<select class="selectpicker form-control" name="Tipo_Carga" title="Seleccione" data-live-search="true" data-width="100%">
														<?php
															if(!isset($_GET['tipo'])){
																?>
																	<option selected="selected" value="nueva">Nueva</option>
																	<option value="actualizacion">Actualización</option>
																<?php
															}else{
																?>
																	<option selected="selected" value="pagos">Pagos</option>
																<?php
															}
														?>
													</select>
												...
												<select class="form-control" id="tablas" data-live-search="true" disabled="disabled">
													<?php
														if(!isset($_GET['tipo'])){
															...
															?>
																<option value="">Seleccione</option>	
																<option value="pagos_deudas_tmp">Pagos</option>
															<?php
														}
													?>
												</select>
