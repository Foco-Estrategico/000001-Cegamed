...
class Usuarios
{
  ...
  public function crearUsuarios($usuario,$nombre,$password,$nivel,$cargo,$idMandante,$userDial,$passDial,$email,$idCedente,$idTrabajador,$idEmpresa)
  {
    ...
    else
    {
      ...
      if ($idTrabajador > 0){
        ...
        mysql_query("UPDATE Personal SET id_usuario='$idNuevoUsuario', Nombre_Usuario='$usuario' Where Id_Personal='$idTrabajador'");
      }
  ...
  public function modificarUsuario($usuario,$nombre,$password,$nivel,$cargo,$idCedente,$userDial,$passDial,$email,$id,$idMandanteUsu,$modificoPassword)
  {
    ...
    else
    {
      if ($modificoPassword)
      {
        mysql_query("Update Usuarios Set usuario='$usuario',nombre='$nombre',clave='$password',nivel='$nivel',Id_Cedente='$idCedente',mandante='$idMandanteUsu' Where id='$id'");
      }else {
        mysql_query("Update Usuarios Set usuario='$usuario',nombre='$nombre',nivel='$nivel',Id_Cedente='$idCedente',mandante='$idMandanteUsu' Where id='$id'");
      }
