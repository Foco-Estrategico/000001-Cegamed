       ...
       // OJOOOOO los que no estan insertados son aquellos que no tienen id en el boton eliminar
        ...
        public function insertarCamposConfig($campos, $idtabla){
            ...
            foreach($campos as $campo){
                ...
                $idCampo = $campo[5];
                if ($idCampo == ""){ // no esta en bd
                  $SqlInsertCampo = "insert into SIS_Columnas_Estrategias (columna, id_tabla, tipo, tipo_dato, orden, logica, Cedente) values('".$columna."', '".$id_tabla."', '".$tipo."','".$tipo_dato."','".$orden."','".$logica."','".$cedente."')";
                  $InsertCampo = $db -> query($SqlInsertCampo);
                }else{
                  $SqlUpdateCampo = "update SIS_Columnas_Estrategias set columna = '".$columna."', tipo = '".$tipo."', tipo_dato = '".$tipo_dato."', orden = '".$orden."', logica = '".$logica."', Cedente = '".$cedente."' where id='".$idCampo."' ";
