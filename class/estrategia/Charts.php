        ...
        public function mostrarTorta($tabla,$cedente,$lista)
        {
            ...
            if($this->lista==-1)
            {
                ...
                while($Result1 = mysql_fetch_array($q1))
                {
                    ...
                    $q2 = mysql_query("SELECT Rut FROM Ultima_Gestion WHERE Respuesta_N1 = $registros AND Id_Cedente = $this->cedente ");
        ...
        public function mostrarTorta2($tabla,$cedente,$lista,$id)
        {
            ...
            if($this->lista==-1)
            {
                ...
                while($Result1 = mysql_fetch_array($q1))
                {
                    ...
                    $registros = $Result1[0];
                    //$q2 = mysql_query("SELECT rut_cliente FROM gestion_ult_semestre WHERE resultado = $registros AND cedente = $this->cedente AND lista=$this->lista");
                    $q2 = mysql_query("SELECT Rut FROM Ultima_Gestion WHERE Respuesta_N2 = $registros AND Id_Cedente = $this->cedente ");
                    $cant =  mysql_num_rows($q2);
                    $Gestion = array();
                    $Gestion["label"] = $nombre;
                    $Gestion["data"] = $cant;
         ...
         public function mostrarTorta3($tabla,$cedente,$lista,$id)
        {
            ...
            if($this->lista==-1)
            {
                ...
                while($Result1 = mysql_fetch_array($q1))
                {
                    ...
                    $registros = $Result1[0];
                    //$q2 = mysql_query("SELECT rut_cliente FROM gestion_ult_semestre WHERE resultado = $registros AND cedente = $this->cedente AND lista=$this->lista");
                    $q2 = mysql_query("SELECT Rut FROM Ultima_Gestion WHERE Respuesta_N3 = $registros AND Id_Cedente = $this->cedente ");
                    $cant =  mysql_num_rows($q2);
                    $Gestion = array();
                    $Gestion["label"] = $nombre;
                    $Gestion["data"] = $cant;
