...
$objetoSession->crearVariableSession($array = array("idMenu" => "email,email_var"));
                            ...
                            <div class="panel">
                                ...
                                <form class="panel-body form-horizontal form-padding">            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">                                     
                                            <select class="selectpicker" title="Seleccione" data-live-search="true" data-width="100%" id="tipo" name="tipo">
                                    ...
                                    <div class="form-group" id="operacion-wrapper" style="display:none;">
                                        ...
                                        <div class="col-md-5">                                     
                                            <select class="selectpicker" title="Seleccione" data-live-search="true" data-width="100%" id="operacion" name="operacion">
                                                <option value="">Seleccione</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">                                     
                                            <select class="selectpicker" title="Seleccione" data-live-search="true" data-width="100%" id="tabla" name="tabla">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3" id="campos-persona">
                                            <select class="selectpicker" title="Seleccione" data-live-search="true" data-width="100%" name="campos">
