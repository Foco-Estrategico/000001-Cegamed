...
$objetoSession->crearVariableSession($array = array("idMenu" => "email,email_temp"));
                        ...
                        <div class="col-lg-8">
                            <div class="panel">
                                ...
                                <div class="panel-body">   
                                    ...
                                    <button id="save-temp" class="btn btn-primary" type="button"> Guardar</button>
                                    <button id="clean-temp" class="btn btn-primary" type="button">Limpiar</button>
                                    <button id="update-temp" class="btn btn-primary" disabled="disabled" type="button"><i class="demo-pli-mail-unread icon-lg icon-fw"></i> Actualizar</button>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody id="templates">
                                                <?php $templates = new opciones;
                                                    echo utf8_encode($templates->templates($con));
                                                ?>
                                            </tbody>
                                        </table>
                                    </form>                 
