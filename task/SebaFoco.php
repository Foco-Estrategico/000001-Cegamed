...
$QueryGestion = mysql_query("SELECT id_gestion,rut_cliente,resultado,fecha_gestion,hora_gestion,fechahora,resultado,observacion,fono_discado,nombre_grabacion,duracion,cedente,fec_compromiso,origen,monto_comp,lista,nombre_ejecutivo FROM gestion_ult_trimestre ",$ConSeba);
