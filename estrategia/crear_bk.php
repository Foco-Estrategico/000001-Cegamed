                                                ...
                                                <div class="panel-body">
                                                 <form id="crear_estrategia" autocomplete="off" name="crear_estrategia" action="#" method="POST">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <div class="form-group">
                                                                <label class="control-label">Seleccione Modo Operación:</label>
                                                                <select class="selectpicker form-control" name="Modo" title="Seleccione" data-live-search="true" data-width="100%">
                                                                    <?php
                                                                        $result=mysql_query("SELECT id,nombre FROM modo_operacion_estrategia ");
                                                                        while($row=mysql_fetch_array($result)){
                                                                    ?>
                                                                            <option value="<?php echo $row[0];?>"><?php echo $row[1];?></option>
                                                                    <?php
                                                        ...
                                                        <div class="col-sm-3">
                                                            <div class="form-group">
                                                                <label class="control-label">Seleccione Periodicidad:</label>
                                                                <select class="selectpicker form-control" name="Periodicidad" title="Seleccione" data-live-search="true" data-width="100%">
                                                                    <?php
                                                                        $result=mysql_query("SELECT id,nombre FROM periodicidad_estrategia ");
                                                                        while($row=mysql_fetch_array($result)){
                                                                    ?>
                                                                            <option value="<?php echo $row[0];?>"><?php echo $row[1];?></option>
                                                                    <?php
                                                        ...
                                                        <div class="col-sm-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="selectpicker form-control" name="Grupo" title="Seleccione" data-live-search="true" data-width="100%">
                                                                    <?php
                                                                        $result=mysql_query("SELECT id,nombre FROM grupo_estrategia ");
                                                                        while($row=mysql_fetch_array($result)){
                                                                    ?>
                                                                            <option value="<?php echo $row[0];?>"><?php echo $row[1];?></option>
                                                                    <?php
