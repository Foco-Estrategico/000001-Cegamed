...
<body>
  ...
  <div id="container" class="effect mainnav-sm">
      ...
      <div class="boxed">
        ...
        <div id="content-container">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Mantenedor tablas por Cedente</li>
          </ol>
          <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
          <!--End breadcrumb-->
          <!--Page content-->
                        ...
                        <!-- INICIO CONTENIDO PRINCIPAL -->
                           <!-- Inicio listar tablas -->
                            ...
                            <div class="row">
                               ...
                               <div class="row">
                                   <div class="col-sm-3">
                                      <button style="margin: 10px 0;" id="AddTabla" class="btn btn-primary btn-block">Agregar tabla</button>
                                   </div>
                               </div>
                           ...
                           <!-- Inicio Asignar tablas al cedente (Registrar tabla y campos) -->
                            <script id="RegistrarTablas" type="text/template">
                              <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                      <div class="col-md-12">
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-8">
                                            <select class="selectpicker" title="Seleccione" id="tablaBD" name="tablaBD" data-live-search="true" data-width="100%">
                                    ...
                                    <div class="row">
                                      <div class="col-md-12">
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-8">                                           
                                            <select class="selectpicker" multiple title="Seleccione" id="camposTabla" name="camposTabla" data-live-search="true" data-width="100%">
                          ...
                          <!--  Fin Asignar tablas al cedente (Registrar tabla y campos) -->
                           <!-- Inicio modificar tablas al cedente (Registrar tabla y campos) -->
                            <script id="ModificarTablas" type="text/template">
                              <div class="row">
                                <div class="col-md-12">
                                  <form class="form-horizontal">
                                    <div class="row">
    ...
    <script src="../js/estrategia/config_tablas.js"></script>
