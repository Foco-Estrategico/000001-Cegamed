$(document).ready(function(){
	...
	$('#agregar').on('click', function(){
		...
		if(campo != ""){
			...
			$("#previsualizar table thead tr").append('<th><span>'+campo+'</span><i class="fa fa-close deleteCol" style="margin-left: 10px; cursor: pointer;"></i></th>');
		}else{
