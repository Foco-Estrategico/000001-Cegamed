$(document).ready(function(){
    ...
    $(document).on('keyup', '#NombreCola', function()
    {
        ...
        else
        {
            ...
            {
                type: "POST",
                url: "../includes/estrategia/MostrarColor.php",
               // data:DataIdTabla,
                success: function(response)
                {
                    $('#DivColor').html(response);
                    $('#SeleccioneColor').selectpicker('refresh');
                }
            });  
        }    
    });
     ...
     $(document).on('click', '#CrearEstrategia', function()
    {
        ...
        var DataQuery = "Valor="+Valor+"&Logica="+Logica+"&NombreCola="+NombreCola+"&IdColumna="+IdColumna+"&IdCedente="+IdCedente+"&IdEstrategia="+IdEstrategia+"&IdSubQuery="+IdSubQuery+"&IdTabla="+IdTabla+"&Color="+Color;
        $.ajax(
        {
            type: "POST",
   ...
   $('#Deshacer').on('click', function()
    ...
    $('#crear_estrategia').submit(function(e)
    {
        ...
        else
        {
            ...
            //var modo = $("select[name='Modo']").val();
            //var periodicidad = $("select[name='Periodicidad']").val();
    ...
    $('#Actualizar').on('click', function(){
        ...
        var IdCedente = $('#IdCedente').val();
        var IdEstrategia = $('#IdEstrategia').val();
        var data = "IdCedente="+IdCedente+"&IdEstrategia="+IdEstrategia;
        $.ajax({
            type: "POST",
