...
$objetoSession->crearVariableSession($array = array("idMenu" => "cal,cal_comp"));
...
<body>
						...
						<div class="eq-height">
							...
							<div class="col-sm-12 eq-box-sm">	
                                ...
                                <!--AUDIOJS [ REQUIRED ]-->
                                            ...
                                            <div class="panel-body" style="padding: 0 10px;">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="selectpicker form-control" name="Ejecutivo" title="Seleccione" data-live-search="true" data-width="100%"></select>
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <button id="FinDeProceso" class="btn btn-primary ElementInvisible" style="margin: 10px 0;" type="submit">Cerrar Evaluaciones Período</button>
                                                </div>
                                    ...
                                    <script id="Observations" type="text/template">
                                        <div class="row">
                                            <div class="cols-sm-1">
                                                <div class="ObservationInputs">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            <label class="control-label">Seleccione Tipo Cierre:</label>
                                                            <select class="selectpicker form-control" name="Tipo_Cierre" title="Seleccione" data-live-search="true" data-width="100%">
    ...
    <script src="../js/calidad/completar_evaluaciones.js"></script>
