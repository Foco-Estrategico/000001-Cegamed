...
$objetoSession->crearVariableSession($array = array("idMenu" => "crm,pred"));
        ...
        <div class="boxed">
            <div id="content-container">
                ...
                <div id="page-content">
                                      ...
                                      <div  id="ContainerRutNumber" style="display: none;">
                                          <div class="col-sm-2">
                                            <div class="form-group has-success">
                                                <input type="text" class="form-control" name="RutNumber" value="fdsfsd">
                                            </div>
                                          </div>
                    ...
                    <div class="row col-lg-12" id="contenido"> <!-- Abre row col-lg-12 111 -->
                        <div class="col-lg-12">
                            <div class="col-md-4">
                                <div class="panel" id="demo-panel-collapse" class="collapse in">
                                    <div class="panel-heading">
