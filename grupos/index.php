<?PHP
	...
	$objetoSession->crearVariableSession($array = array("idMenu" => "tar,grupos"));
							...
							<div class="col-md-12">
								<div class="panel">
									...
									<div class="panel-body">
										...
										<div class="row">
											<div class="col-md-4 form-group">
												<label>Personas</label>
										  		<select class="form-control selectpicker"  data-live-search="true" id="listPersonas" data-size="10">
										...
										<div class="row">
											<div class="col-md-12 form-group" id="contTagPersonas">
										...
										<div class="row">
											<div class="col-md-4 form-group">
												<label>Empresas</label>
										  		<select class="form-control selectpicker"  data-live-search="true" id="listEmpresas" data-size="10">
										  		<option>Seleccione...</option>
										  		</select>
											</div>
											<div class="col-md-4 form-group">
										...
										<div class="row">
											<div class="col-md-12">
												...
												<button type="button" class="btn btn-success" style="display:none;" id="updateGrupo"><i class="ti-save"></i> Actualizar Grupo</button>
											</div>
										</div>
									</div>
								</div>
