...
$objetoSession->crearVariableSession($array = array("idMenu" => "adm,conf_aRptDial"));
...
<body>
  ...
  <div id="container" class="effect mainnav-sm">
          ...
          <!--===================================================-->
                ...
                <div class="row">
                    <div class="panel">
                        <div class="panel-heading">
                            <h2 class="panel-title">Mantenedor</h2>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <button style="margin: 10px 0;" id="AddColumna" class="btn btn-primary btn-block">Agregar Columna</button>
                                </div>
                            </div>
                            <div class="row">
                                <table id="Columnas">
            ...
            <script id="AddColumnaTemplate" type="text/template">
                <div class="row">
                    ...
                    <div class="col-md-12 Hidden" id="FieldsContainer">
    ...
    <script src="../js/tareas/config-ColumnasAsignacionRptDial.js"></script>
</body>
</html>
