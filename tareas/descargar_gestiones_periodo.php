...
$objetoSession->crearVariableSession($array = array("idMenu" => "mastfile,asigper"));
...
<body>
  ...
  <div id="container" class="effect mainnav-sm">
                ...
                <div class="row">
                    <div class="panel">
                        <div class="panel-heading">
                            <h2 class="panel-title">Descargar Gestiones</h2>
                        </div>
    ...
    <script src="../js/tareas/gestion-periodo.js"></script>
</body>
</html>
