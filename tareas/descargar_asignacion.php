<?php
    ...
    $objetoSession = new Session('2',false);
    //Para Id de Menu Actual (Menu Padre, Menu hijo)
    $objetoSession->crearVariableSession($array = array("idMenu" => "mastfile,drdAsig"));
...
<body>
  ...
  <div id="container" class="effect mainnav-sm">
      ...
      <div class="boxed">
        ...
        <div id="content-container">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Informe de gestiones</li>
          </ol>
          <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
          <!--End breadcrumb-->
          <!--Page content-->
                ...
                <div class="row">
                    <div class="panel">
                        <div class="panel-heading">
                            <h2 class="panel-title">Descargar Asignacion</h2>
                        </div>
    ...
    <script src="../js/tareas/descargar-asignacion.js"></script>
</body>
</html>
